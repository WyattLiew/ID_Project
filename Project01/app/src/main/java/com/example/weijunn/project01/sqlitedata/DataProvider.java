...
public class DataProvider {
    ...
    public DataProvider(String location, String name, String number,String projManager,String date,String defect1, String defect2, String defect3, String comments,byte[] img){
        this.img = img;
        this.location = location;
        this.name =name;
        this.number =number;
